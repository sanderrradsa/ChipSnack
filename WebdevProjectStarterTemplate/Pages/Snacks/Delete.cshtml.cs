...
namespace WebdevProjectStarterTemplate.Pages.Snacks
{
    ...
    public class Delete : PageModel
    {
        ...
        {
            Snack = new SnackRepository().Get(snackId); // Haal de snack op met het opgegeven snackId
        }
        // Handler voor POST-verzoek om de snack te verwijderen
        public IActionResult OnPostDelete([FromRoute] int snackId)
        {
            bool success = new SnackRepository().Delete(snackId); // Verwijder de snack met het opgegeven snackId
